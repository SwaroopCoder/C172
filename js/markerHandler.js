...
AFRAME.registerComponent("markerhandler", {
  ...
  handleOrderSummary: async function () {
    ...
    var totalTr = document.createElemrnt("tr")

    var td1 = document.createElement("td")
    td1.setAttribute("alss","no-line")
  ...
  document.setElementryId("modal-div").style.display = "none"
  ...
  .then(()=> {
    swal({
      ...
      text:"We hape you enjoyed your food!",
      timer:2500,
      buttons:false
    })
  })
